                    ...
                    <div class="row">
                        <div class="col-sm-10 col-lg-6 offset-sm-1 offset-lg-3">
                            <div class="form-bg">
                                ...
                                $result = $ins->hien_bv_id($id);
                                if (!empty($result)) {
                                    while ($row = $result->fetch_assoc()) {
                                ?>
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <input type="text" name="ten_kt" class="form-control" value="<?php echo $row["ten_bv"] ?>" placeholder="Tên Kiểu tóc">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="mo_ta" class="form-control" value="<?php echo $row["mo_ta_bv"] ?>" placeholder="mô tả kiểu tóc">
                                            </div>
                                            <div class="form-group">
