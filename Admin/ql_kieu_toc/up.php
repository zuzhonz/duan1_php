                        ...
                        <div class="col-sm-10 col-lg-6 offset-sm-1 offset-lg-3">
                            <div class="form-bg">
                                ...
                                if (isset($_POST['sup'])) {
                                    ...
                                    $result =  $ins->sua_kt($ten, $pl, $image, $mo_ta, $id);
                                }
                                ...
                                $result = $ins->show_kt_id($id);
                                if (!empty($result)) {
                                    while ($row = $result->fetch_assoc()) {
                                ?>
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <input type="text" name="ten_kt" class="form-control" value="<?php echo $row["ten_kt"] ?>" placeholder="Tên Kiểu tóc">
                                            </div>

                                            <div class="form-group">
                                                <input type="text" name="phan_loai" class="form-control" value="<?php echo $row["phan_loai"] ?>" placeholder="phân loại">
                                            </div>
                                            <div class="form-group">
                                                <input type="file" name="image">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="mo_ta" class="form-control" value="<?php echo $row["mo_ta_kt"] ?>" placeholder="mô tả kiểu tóc">
                                            </div>
                                            <div class="form-group">
